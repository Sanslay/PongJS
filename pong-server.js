...
var networkInterfaces = os.networkInterfaces( );
    ...
    console.log('Liste de vos reseaux'.red);
}
catch(ex)
{
    console.log( 'Erreur d affichage des adresses'.red);
}
checkInternet(function(isConnected) {
    if (isConnected) {
        console.log('La connection interne est validé lors du lancement de l application'.red);
    }
    else
    {
        console.log('Erreur pas de connection interne'.red);
        return 0
    }
});
// Parameter systems
