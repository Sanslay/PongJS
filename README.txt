...
Etape2:
Changer la valeur de la variable serverAddr à la ligne 20 dans le fichier index.html, mettez à la place  l’adresse IP de l'ordinateur qui héberge le serveur. Elle doit avoir la forme : ‘000.000.000.000 :8080/’
...
Si il vous manque des packages, utilisé les npm pour les télécharger.

Etape 4 :
Lancer  votre navigateur web, entrer une des adresses : localhost :8080 ou ipserveur :8080
Pour information l’afficheur  Raphael est optimisé pour une utilisation sur CHROME.
La première  connexion peut être longue.

Etape 5 :
La page index.html s’affiche, vérifier dans les log du serveur si un client est bien connecté. Dans le cas contraire appuyer  sur  « Recharger la page »
Si c’est bien les cas un formulaire avec l’indication «  Vous etes le joueur bleu / rouge » s’affiche en bas à gauche de la page. Il faut que chacun des joueurs remplissent le formulaire est indique qu’il soit prêt pour que le jeu commence.
Dans le formulaire :
...
Un tchat est disponible pour discuter avec les autres clients.
